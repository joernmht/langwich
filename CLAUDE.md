...
- `src/langwich/graph.py` — node hierarchy, the 24 exercise subclasses (six
  families: Fill-in-Blanks, Picture, Word Connections, Reading & Comprehension,
  Vocabulary Work, Writing & Discussion), edges, CEFR/difficulty/focus metadata,
  and the learner-facing titles/instructions.
